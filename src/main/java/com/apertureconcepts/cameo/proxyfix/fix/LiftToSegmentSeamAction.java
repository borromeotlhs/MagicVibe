...
public class LiftToSegmentSeamAction extends AbstractLiftConnectorAction {

    public LiftToSegmentSeamAction(String id, String name, Connector connector, BoundaryContext left, BoundaryContext right) {
